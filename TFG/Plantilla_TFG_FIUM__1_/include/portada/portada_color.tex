...
\begin{titlepage}
	...
	\begin{tikzpicture}[overlay, remember picture, inner sep=0pt, outer sep=0pt]
		\node[anchor=north west,inner sep=0pt] at ($(current page.north west)+(1cm,-1cm)$)
			{\includegraphics[width=6cm]{\logoUniversidadPortada}};
	\end{tikzpicture}

	% Logo de la facultad en la esquina superior derecha
	\begin{tikzpicture}[remember picture,overlay]
		\node[anchor=north west,inner sep=0pt] at ($(current page.north west)+(15.5cm,-1.75cm)$)
	    	{\includegraphics[width=4.5cm]{\logoFacultadPortada}};
	\end{tikzpicture}
	...
	\node[anchor=south west,inner sep=0pt] at ($(current page.south west)+(12cm,1.7cm)$)
	              {\includegraphics[width=7.5cm]{\logoFacultadPortadaBaja}};
	\end{tikzpicture}
